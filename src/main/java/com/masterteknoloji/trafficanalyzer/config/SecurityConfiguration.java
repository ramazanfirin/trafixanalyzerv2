...
import com.masterteknoloji.trafficanalyzer.security.*;
import com.masterteknoloji.trafficanalyzer.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
            ...
            .antMatchers("/api/raw-records/parseData/**")
            .antMatchers("/api/video-records/generateExcelFile/**")
            .antMatchers("/api/analyze-orders/getAllSummary/**")
            .antMatchers("/api/lines/getLineSummaryListByScenarioId/**")
            ...
            .antMatchers("/api/analyze-orders/getScreenShoot/**")

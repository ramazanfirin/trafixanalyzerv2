...
public final class HeaderUtil {
    ...
    private static final String APPLICATION_NAME = "trafficanalzyzerv2App";
    ...
    public static HttpHeaders createAlert(String message, String param) {
        ...
        headers.add("X-trafficanalzyzerv2App-alert", message);
        headers.add("X-trafficanalzyzerv2App-params", param);
        return headers;
    }
